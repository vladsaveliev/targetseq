...
barcode ()
{
    local HTMLOUT="${RESULTS_DIR}/${HTML_RESULTS}"
    ...
    do
        BARCODE=${BARCODES[$BCN]}
        BARCODE_DIR="${RESULTS_DIR}/${BARCODE}"
        BARCODE_BAM="${BARCODE}_${PLUGIN_OUT_BAM_NAME}"
