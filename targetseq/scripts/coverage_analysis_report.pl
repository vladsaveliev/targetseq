...
print OUTFILE "  img.frm {display:block;margin-left:auto;margin-right:auto;margin-top:10px;margin-bottom:10px;width:700;height:700;border-width:0;cursor:help}\n";
