...
END {
  ...
  printf "Target coverage at 500x: %.3f%%\n",cum_coverage[500]*scl;
  printf "Target coverage at 1000x: %.3f%%\n",cum_coverage[1000]*scl;
  printf "Target coverage at 2500x: %.3f%%\n",cum_coverage[2500]*scl;
  printf "Target coverage at 5000x: %.3f%%\n",cum_coverage[5000]*scl;
  printf "Target coverage at 10000x: %.3f%%\n",cum_coverage[10000]*scl;
}
